<div class="col-lg-12">
    <h1> Data Lembur Karyawan <small>Admin APeK</small></h1>
    <ol class="breadcrumb">
...
<div class="col-lg-12">
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title"><i class="fa fa-user"></i> Data Lembur Karyawan </h3> 
        </div>
        <div class="panel-body">
            ...
            <?php
                $tampil= mysqli_query($con, "SELECT g.*, k.*
                                            ...
                                            where g.jam_lembur is not null");
            ?>
                <table class="table table-bordered table-hover table-striped tablesorter">
                    ...
                    <tr>
                        ...
                        <td><?php echo date('d F Y', strtotime($data['tgl_transfer'])) ?></td>
                        <td><?php echo date('H:i', strtotime($data['jam_transfer'])) ?></td>
                    </tr>
                    <?php } ?>
                    </tbody>
                </table>
            ...
            <div class="text-right">
                <a href="layout.php?page=gCreate" class="btn btn-sm btn-warning">Print <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div> 
    </div>
</div>